      ...
      <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5 dark:border-gray-800 dark:bg-gray-950">
        ...
        <div className="mt-4 flex flex-col gap-2">
          ...
          {summary ? (
            ...
            <div className="mt-2 text-sm text-gray-700 dark:text-gray-200">We’ll follow up if we need any clarifications.</div>
          )}
        </div>
      </div>
      ...
      {aiRenderingEnabled && renderOptIn ? (
        ...
        >
          ...
          {renderImageUrl ? (
            ...
            <div className="text-sm text-gray-600 dark:text-gray-300">If enabled, your visual concept will appear here when ready.</div>
          )}
        </div>
      ) : null}
