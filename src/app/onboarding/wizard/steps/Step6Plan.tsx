    ...
    return [
      {
        ...
        accent: {
          ...
          glow: "bg-[radial-gradient(circle_at_35%_25%,rgba(148,163,184,0.30),transparent_55%)]",
      ...
      },
      {
        ...
        accent: {
          ...
          glow:
            "bg-[radial-gradient(circle_at_20%_15%,rgba(99,102,241,0.38),transparent_55%),radial-gradient(circle_at_70%_30%,rgba(168,85,247,0.28),transparent_60%),radial-gradient(circle_at_50%_95%,rgba(34,211,238,0.18),transparent_60%)]",
          usage: "bg-indigo-500",
        },
        features: [
          "Unlimited quotes",
  ...
  function CheckIcon({ className = "" }: { className?: string }) {
    return (
      <svg
        viewBox="0 0 20 20"
        aria-hidden="true"
        className={["h-4 w-4 flex-none", className].join(" ")}
        fill="none"
      >
        <path
              ...
              return (
                ...
                >
                  ...
                  <div
                    aria-hidden="true"
                    className={[
                      "pointer-events-none absolute -inset-8 rounded-[44px] blur-3xl",
                      p.accent.glow,
                  ...
                  <div
                    className={[
                      "relative rounded-[22px] ring-1",
                      p.accent.ring,
                      active ? "bg-white/70 dark:bg-gray-950/60" : "bg-white/60 dark:bg-gray-950/50",
                    ].join(" ")}
                  >
                    {/* Inner sheen when selected */}
                    {active ? (
                      <div
                        aria-hidden="true"
                        className="pointer-events-none absolute inset-0 rounded-[22px]
                          bg-[radial-gradient(circle_at_20%_10%,rgba(255,255,255,0.55),transparent_35%)]
                          dark:bg-[radial-gradient(circle_at_20%_10%,rgba(255,255,255,0.10),transparent_40%)]"
                      />
                    ) : null}
                    ...
                    <div className="relative p-5">
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        {/* Fixed width price column to prevent overlap */}
                        <div className="shrink-0 text-right w-[120px] sm:w-[140px]">
                      ...
                      <div className="mt-5">
                        ...
                        <UsageBars
                          filled={p.usage.filled}
                          total={p.usage.total}
                          barClass={p.accent.usage}
                        />
                      </div>
