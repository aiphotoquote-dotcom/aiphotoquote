    ...
    <div className="mx-auto max-w-6xl px-6 py-10 space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
          Prompts are layered <span className="font-mono">platform → industry → tenant</span>. Tenant inputs are treated as{" "}
          <span className="font-semibold">additions</span> to the baseline (not a separate “mode”). Guardrails remain platform-locked.
        </p>
      </div>
